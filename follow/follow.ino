...
const int motorREnable = 10; // enable pin for the right motor (needs to be PWM enabled)
...
const int motorLEnable = 11; // enable pin for the left motor (needs to be PWM enabled)
