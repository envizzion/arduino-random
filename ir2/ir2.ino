...
const int motorRPin2 = 23;  // signal pin 2 for the right motor, connect to IN2
const int motorREnable = 13; // enable pin for the right motor (needs to be PWM enabled)

const int motorLPin1 = 24; // signal pin 1 for the left motor, connect to IN3 (was 5 - need to change)             
const int motorLPin2 = 27; // signal pin 2 for the left motor, connect to IN4
const int motorLEnable = 4; // enable pin for the left motor (needs to be PWM enabled)
